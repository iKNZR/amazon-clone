      ...
      <div className="min-w-[1000px] max-w-[1500px] m-auto p-4">
        <div className="grid grid-cols-10">
          ...
          <div className="col-span-2 p-4 rounded bg-white">
              ...
              <div className="text-base xl:text-lg text-gray-500 font-semibold">RRP: <span className="line-through">{GB_CURRENCY.format(product.oldPrice)}</span></div>
              ...
              <div className="text-base xl:text-lg font-semibold mt-1">Quantity: 
